...
public class CustonRatingbar extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        resId = array.getResourceId(R.styleable.CustomRatingbar_cr_src, R.mipmap.star2);
        likeResid = array.getResourceId(R.styleable.CustomRatingbar_cr_like_src, R.mipmap.star);

        mSize = array.getResourceId(R.styleable.CustomRatingbar_cr_size, R.dimen.dp_20);
