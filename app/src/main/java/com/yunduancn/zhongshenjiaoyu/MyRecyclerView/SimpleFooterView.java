package com.yunduancn.zhongshenjiaoyu.MyRecyclerView;
...
public class SimpleFooterView extends BaseFooterView{
    ...
    public SimpleFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.list_foot_loading, this);
    ...
    @Override
    public void onWZ(CharSequence message) {
        mText.setText(message);
        //mText.setText("啊哦，好像哪里不对劲!");
    }
