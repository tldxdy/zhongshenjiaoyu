package com.yunduancn.zhongshenjiaoyu.MyRecyclerView.adapter;
...
import com.yunduancn.zhongshenjiaoyu.MyRecyclerView.widget.ProgressWheel;
...
public abstract class BaseAdapter<M, IVH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof FooterViewHolder) {
            ...
            if (!hasMoreData) {
                ...
                footerViewHolder.loadMore.setText("加载更多...");
            }
        } else {
    ...
    public void setJZDataList(List<M> data) {
    ...
    public void setSXDataList(List<M> data) {
        if (data == null || data.size() == 0)
            return;
        dataList.clear();
        dataList.addAll(data);
