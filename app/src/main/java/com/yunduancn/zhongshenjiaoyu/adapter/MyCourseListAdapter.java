 ...
 */
public class MyCourseListAdapter extends BaseAdapter<String, MyCourseListAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        return new ItemViewHolder(mLayoutInflater.inflate(R.layout.my_course_item, parent, false));
    }
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView course_study;
        private final TextView course_name;
        private final ImageView course_img;
        private final TextView course_describe;

        public ItemViewHolder(View itemView) {
            super(itemView);

             course_name = (TextView) itemView.findViewById(R.id.course_name);
             course_describe = (TextView) itemView.findViewById(R.id.course_describe);
             course_study = (TextView) itemView.findViewById(R.id.course_study);
