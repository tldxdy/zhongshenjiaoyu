 ...
 */
public class Course_ProblemAdapter extends BaseAdapter<ThreadListModel, Course_ProblemAdapter.ItemViewHolder> {

    private Context mContext;
    private final LayoutInflater mLayoutInflater;

    public Course_ProblemAdapter(Context context) {
        super(context);
