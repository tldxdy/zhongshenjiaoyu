...
public class News5Fragment extends Fragment  implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initDatasx() {
        ...
        map.put("categoryCode", NewsFragment.list.get(4).getCode());
