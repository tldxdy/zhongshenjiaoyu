...
public class News3Fragment extends Fragment  implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initDatasx() {
        ...
        map.put("categoryCode", NewsFragment.list.get(2).getCode());
