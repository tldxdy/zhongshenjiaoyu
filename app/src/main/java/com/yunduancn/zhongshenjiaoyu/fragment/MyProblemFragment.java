...
public class MyProblemFragment  extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {



    public MyProblemFragment() {
    ...
    private void initView() {
        ...
        mAdapter = new MyProblemAdapter(getContext());
