...
public class News2Fragment extends Fragment  implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initDatasx() {
        ...
        map.put("categoryCode", NewsFragment.codes.get(1));
        OkHttp_Utils.PostMethods(map, UrlUtils.articleurl, new OkHttp_Utils.CallBack() {
            ...
            public void onMyResponse(String response, int id) {
                Dialogmanager.loadfinsh(0);
                L.e("==========1==========="+ NewsFragment.codes.get(1),response.toString());
                try {
