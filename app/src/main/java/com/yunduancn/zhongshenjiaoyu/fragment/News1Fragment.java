...
public class News1Fragment extends Fragment  implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initDatasx() {
        ...
        map.put("categoryCode", NewsFragment.codes.get(0));
        OkHttp_Utils.PostMethods(map, UrlUtils.articleurl, new OkHttp_Utils.CallBack() {
            ...
            public void onMyResponse(String response, int id) {
                Dialogmanager.loadfinsh(0);
                L.e("==========0===========" + NewsFragment.codes.get(0),response.toString());
                try {
