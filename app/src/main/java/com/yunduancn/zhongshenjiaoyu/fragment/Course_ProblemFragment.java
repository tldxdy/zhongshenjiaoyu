...
public class Course_ProblemFragment extends Fragment  implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {



    public Course_ProblemFragment() {
    ...
    private Course_ProblemAdapter mAdapter;
    ...
    private void initView() {
        ...
        mAdapter = new Course_ProblemAdapter(getContext());
   ...
   /* private void initData() {
    ...
    private void initDatajz() {
        ...
        OkHttp_Utils.PostMethods(map, UrlUtils.threadurl, new OkHttp_Utils.CallBack() {
            @Override
